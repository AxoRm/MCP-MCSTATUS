...
mcp = FastMCP(
    name="mcstatus-mcp",
    instructions=(
        "Tools for Minecraft server status, DNS/BGP, reverse DNS, MaxMind GeoIP, provider, and Anycast checks. "
        "Use these tools whenever host status, DNS/SRV, BGP, PTR, provider, geolocation, or Anycast info is needed."
    ),
